...
public class PlayerESP extends Module {
        ...
        if (renderTracers) {
            ...
            for (Entity entity : client.level.entitiesForRendering()) {
                ...
                if (isTrajTarget || isEnabledInPicker) {
                    ...
                    // Tracer mit Linienbreite 2.0f
                    line(matrix, normalMatrix, tracerConsumer, startX, startY, startZ, targetX, targetY, targetZ, color, 2.0f);
                }
            }
        }
    ...
    private static void renderBoxOutline(Matrix4f matrix, Matrix3f normalMatrix, VertexConsumer consumer, float x1, float y1, float z1, float x2, float y2, float z2, int color) {
        ...
        // Vertikale Streben (Hier war der Fehler in der letzten Zeile!)
        ...
        line(matrix, normalMatrix, consumer, x1, y1, z2, x1, y2, z2, color, width); // y1 zu y2 korrigiert
    }
