...
public class ItemPicker extends Component {
    ...
    public void render(Object graphics, int mouseX, int mouseY) {
        ...
        UISettings.drawText(guiGraphics, Minecraft.getInstance().font, title, x, y + 1, p.accent, false);
        ...
        for (int i = 0; i < maxVisible; i++) {
            ...
            UISettings.drawText(guiGraphics, Minecraft.getInstance().font, name, dropX + UISettings.scaled(selected ? 17 : 7), itemY + (itemH / 2) - UISettings.scaled(4), itemColor, false);
